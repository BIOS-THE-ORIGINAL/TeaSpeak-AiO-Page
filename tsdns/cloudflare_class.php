...
class CloudFlareAPI{	
	...
	public function listDNSrecords() {	
		...
		return false;
			...
			public function a_kaydi_ekle($dns,$port,$cloudflare_proxy = false) {	
		/* PARSING RESPONSE */
		$ch = curl_init();				
		$srvdata = array(
...
//		print_r($response);
		...
		public function srv_ekle($dns,$domain,$port,$cloudflare_proxy = false) {	
		/* PARSING RESPONSE */
		$ch = curl_init();				
		$srvdata = array(
		'type' => 'SRV',
